 ...
 * Layer switchers
 */
#define L_NAVIG LT(_NAV, KC_D)
#define L_DIGTS LT(_DGS, KC_D)
#define L_FUNKS LT(_FNS, KC_F)
#define L_BRACS LT(_BRS, KC_B)
#define L_SYST1 LT(_SY1, KC_R)
#define L_SYST2 LT(_SY2, KC_U)
#define L_SYSTS LT(_SYS, KC_APP)
...
enum work40_layers { _QWE, _NAV, _EDI, _DGS, _FNS, _BRS, _SY1, _SY2, _SYS, __SP, __S1 };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                 KC_LGUI,   MO(1), SFT_SPC,   BSPC_DEL,   MO(2), KC_RALT
                             //`--------------------------'  `--------------------------'
